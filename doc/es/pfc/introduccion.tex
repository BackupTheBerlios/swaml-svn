...
\begin{itemize}
  ...
  \item Obtener información sobre los suscriptores de una lista de correo. Por ejemplo, 
	conocer en qué otras listas de correo participa una persona. Esta aplicación es 
	especialmente interesante en conexión con FOAF\footnote{http://www.foaf-project.org/}.
	De este modo, se podría sacar una \emph{orla} con las fotos de los participantes 
	en una lista de correo \footnote{Como hace GNOME, véase http://planet.gnome.org/heads/}, 
	o situarlos geográficamente en un mapa
	\footnote{Como hace Debian, véase http://www.debian.org/devel/developers.loc}
...
\begin{itemize}
  \item El proyecto DOAML\footnote{http://www.doaml.net/} consiste en un 
	...
	de éstos.
  \item Por otro lado, EMiR\footnote{http://xmlns.filsa.org/emir/} es un 
	esquema RDF para describir mensajes de correo electrónico. 
  \item En la misma línea se encuentra XMTP\footnote{http://www.openhealth.org/xmtp/}.
\end{itemize}
