...
class KML:
  ...
  def __init__(self, comment=None):
    ...
    self.root.setAttribute("xmlns", "http://earth.google.com/kml/2.0")
    if comment:
  ...
  def createPlacemark(self, name, lat=None, lon=None, desc=None, style=None, range=None, tilt=None, alt=None, heading=None, visible=True, altMode=None):
  ...
  def writepretty(self, f, encoding="utf-8"):
    PrettyPrint(self.xml, f, encoding=encoding)
